...
const MessageInput = () => {
    ...
    //                 className='flex-1 bg-slate-800/50 border border-slate-700/50 rounded-lg py-3 px-4
    ...
    //                 className={`bg-slate-800/50 text-slate-400 hover:text-slate-200 
    //                     rounded-lg px-4 transition-colors ${image ? "text-cyan-500" : ""
    //                     }
    //                 !cursor-pointer
    //                     `}
    //             >
    ...
    //                         className="bg-gradient-to-r from-cyan-500 to-cyan-600 text-white rounded-lg px-4 py-2 font-medium hover:from-cyan-600 hover:to-cyan-700 transition-all 
    ...
    //             <button
    //                 type="submit"
    //                 disabled={!text.trim() && !imagePreview} // هيفضل معطل لو مفيش داتا بس موجود
    //                 className={`
    //     /* المساحات والأبعاد الثابتة */
    //     shrink-0 w-12 h-12 flex items-center justify-center rounded-xl ml-2
